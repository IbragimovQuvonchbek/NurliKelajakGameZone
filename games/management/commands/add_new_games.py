        ...
        games_data = [
            {
                ...
                'description_uzbek': 'Vaqt chеgarasi ichida harflarni shakllantirish uchun tartiblashtiringiz.',
                'category': 'word',
            ...
            },
            {
                'name': 'Capital Quest',
                'slug': 'capital-quest',
                'description': 'Match world capitals to their countries.',
                'description_uzbek': 'Dunyoning poytaxtlarini ularning davlatlariga moslashtiring.',
                'category': 'geography',
                'difficulty_level': 'medium',
                'icon': 'fa-globe',
                'is_active': True,
            },
            {
                'name': 'Tile Match',
                'slug': 'tile-match',
                'description': 'Merge matching tiles to reach 2048.',
                'description_uzbek': '2048 ga erishish uchun mos keluvchi plitalarni birlashtiringiz.',
                'category': 'puzzle',
                'difficulty_level': 'medium',
                'icon': 'fa-th',
                'is_active': True,
